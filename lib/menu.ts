...
export const MENU_ITEMS: MenuItem[] = [
  ...
  {
    id: 'cheddar-bacon-pizza',
    name: 'Cheddar Bacon Pizza',
    description: 'Sugo, mozzarella, slanina, cheddar a červená cibule.',
    price: 239,
    category: 'pizzy',
    image: '/food/pizza-cheddar-bacon.jpg',
  },
  {
    id: 'cheddar-melt-pizza',
    name: 'Cheddar Melt Pizza',
    description: 'Mozzarella, cheddar, hermelín a parmazán.',
    price: 229,
    category: 'pizzy',
